        ...
        <Tabs defaultValue="month" className=" ">
          ...
          <TabsContent value="month" className="w-full">
            <div className="  sm:p-6 grid sm:grid-cols-3 grid-cols-1 w-full gap-6">
              ...
              <div className="w-[25rem] h-[28rem] border border-solid text-white bg-primary  rounded-xl shadow-xl text-left p-7 flex flex-col gap-5  bg-gradient-to-t from-primary from-20% to-secondary">
          ...
          <TabsContent value="year">
            <div className="  sm:p-6 grid sm:grid-cols-3 grid-cols-1 w-full gap-6">
              ...
              <div className="w-[25rem] h-[28rem]  text-primary shadow-2xl rounded-xl text-left p-7 flex flex-col gap-5 ">
                <div className="font-bold">Professional</div>
                <div className="text-5xl font-bold">$2</div>
                <div>Free plan for all users</div>
              ...
              <div className="w-[25rem] h-[28rem]   bg-primary  rounded-xl text-white text-left p-7 flex flex-col gap-5  bg-gradient-to-t from-primary from-20% to-secondary">
                <div className="font-bold">Premium</div>
                <div className="text-5xl font-bold">$5</div>
                <div>Free plan for all users</div>
